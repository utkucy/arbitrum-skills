...
Extension of [ERC-20](erc20.md) that adds a cap to the supply of tokens.

[[usage]]
## Usage

In order to make https://docs.rs/openzeppelin-stylus/0.3.0/openzeppelin_stylus/token/erc20/extensions/capped/index.html[`ERC-20 Capped`] methods supervising the supply of tokens, you need to add them by yourself for your final contract as follows:

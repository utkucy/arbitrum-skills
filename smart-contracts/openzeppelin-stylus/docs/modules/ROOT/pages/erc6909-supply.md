...
The OpenZeppelin [ERC-6909](erc6909.md) Token Supply extension that adds tracking of total supply per token id.
Useful for scenarios where Fungible and Non-fungible tokens have to be clearly identified.

[[usage]]
## Usage

In order to make an [ERC-6909](erc6909.md) token with https://docs.rs/openzeppelin-stylus/0.3.0/openzeppelin_stylus/token/erc6909/extensions/supply/index.html[Supply] flavour,

...
The OpenZeppelin [ERC-1155](erc1155.md) Metadata URI extension is needed to manage and store URIs for individual tokens. This extension allows each token to have its own unique URI,
...
In order to make an [ERC-1155](erc1155.md) token with https://docs.rs/openzeppelin-stylus/0.3.0/openzeppelin_stylus/token/erc1155/extensions/metadata_uri/index.html[Metadata URI] flavour,

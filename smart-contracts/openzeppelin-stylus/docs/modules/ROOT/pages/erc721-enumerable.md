...
The OpenZeppelin [ERC-721](erc721.md) Enumerable extension is used to provide additional functionality to the standard ERC-721 token. Specifically, it allows for enumeration of all the token IDs in the contract as well as all the token IDs owned by each account. This is useful for applications that need to list or iterate over tokens, such as marketplaces or wallets.

[[usage]]
## Usage

In order to make an [ERC-721](erc721.md) token with https://docs.rs/openzeppelin-stylus/0.3.0/openzeppelin_stylus/token/erc721/extensions/enumerable/index.html[Enumerable] flavour,

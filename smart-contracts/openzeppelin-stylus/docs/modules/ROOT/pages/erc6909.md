...
On the https://docs.rs/openzeppelin-stylus/0.3.0/openzeppelin_stylus/token/erc6909/struct.Erc6909.html[`API reference`] you'll find detailed information on their properties and usage.

[[constructing-an-erc6909-token-contract]]
## Constructing an ERC-6909 Token Contract

We can easily create our own ERC-6909 token contract that brings all token operations into the single interface,
without the need of multiple approvals or tracking allowances across contracts.
This lets you focus on your application’s core logic while it handles token management.

Here's what our `Erc6909Example` token might look like.
...
* [ERC-6909 Supply](erc6909-supply.md): Extension of the ERC-6909 standard that adds total supply functionality for each token id.
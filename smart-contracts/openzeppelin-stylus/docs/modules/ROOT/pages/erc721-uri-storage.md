...
The OpenZeppelin [ERC-721](erc721.md) URI Storage extension is needed to manage and store URIs for individual tokens. This extension allows each token to have its own unique URI,
...
In order to make an [ERC-721](erc721.md) token with https://docs.rs/openzeppelin-stylus/0.3.0/openzeppelin_stylus/token/erc721/extensions/uri_storage/index.html[URI Storage] flavour,

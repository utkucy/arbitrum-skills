...
Extension of [ERC-1155](erc1155.md) that allows token holders to destroy both their
own tokens and those that they have been approved to use.

[[usage]]
## Usage

In order to make https://docs.rs/openzeppelin-stylus/0.3.0/openzeppelin_stylus/token/erc1155/extensions/burnable/index.html[`ERC-1155 Burnable`] methods “external” so that other contracts can call them, you need to implement them by yourself for your final contract as follows:

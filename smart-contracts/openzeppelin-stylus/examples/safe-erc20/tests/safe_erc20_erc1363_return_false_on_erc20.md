# Safe Erc20 Erc1363 Return False On Erc20
...
async fn reverts_on_transfer_and_call_relaxed(
    ...
    .expect_err("should revert with ERC1363TransferFailed");

    // TODO: once SafeErc20 is returning Vec<u8> for all errors, update this to
    // `ERC1363::ERC1363TransferFailed`
...
async fn reverts_on_transfer_from_and_call_relaxed(
    ...
    .expect_err("should revert with ERC1363TransferFromFailed");

    // TODO: once SafeErc20 is returning Vec<u8> for all errors, update this to
    // `ERC1363::ERC1363TransferFromFailed`
    assert!(err.reverted_with(SafeErc20::SafeErc20FailedOperation {
        token: erc20_address,
    }));
...
async fn reverts_on_approve_and_call_relaxed(
    ...
    .expect_err("should revert with ERC1363ApproveFailed");

    // TODO: once SafeErc20 is returning Vec<u8> for all errors, update this to
    // `ERC1363::ERC1363ApproveFailed`
    assert!(err.reverted_with(SafeErc20::SafeErc20FailedOperation {
        token: erc20_address,
    }));

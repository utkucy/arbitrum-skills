# Quickstart - Covalent Indexing and Querying API
...
- **Features:** All token balances (`ERC-20`, `721`, `1155`, native), token transfers and prices (spot & historical) for a wallet.
...
There are three primary developer tools for using the APIs:

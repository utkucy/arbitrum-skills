...
| transactionRequest.`walletId`   | Body       | The `id` of the wallet that will initiate the transaction          | String    | ✅        |
| transactionRequest.`to`         | Body       | Destination Address (can be a blockchain address or email address) | String    | ✅        |
| transactionRequest.`secretType` | Body       | On which blockchain the transaction will be executed               | String    | ✅        |

...
- Assess the safety of interacting with a given address (any address: EOA, smart contract, token, etc.). Screen for denylists, sanctioned addresses, malicious behavior, and other potential flags

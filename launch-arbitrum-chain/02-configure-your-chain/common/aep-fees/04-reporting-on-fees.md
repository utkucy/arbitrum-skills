...
- L1 Base Fee is for cost recovery only (NOT for profit)
- L1 Surplus is for profit collection
...
Method 1 and Method 2 should be roughly equivalent over the long term.

...
- **`l2BaseFee`**: Fees paid to execute a transaction on the Arbitrum chain.
- **`l2SurplusFee`**: Surplus fees are charged in addition to the base fee when an Arbitrum chain is congested.

# Arbitrum chain licensing

## What do I need to know about the Arbitrum chain license?
...
- L3s that settle to parent chains other than Arbitrum One and Nova must contribute [net chain revenue](/launch-arbitrum-chain/02-configure-your-chain/common/aep-fees/03-calculate-aep-fees.mdx#calculating-aep-fees), where 8% flows to the DAO and 2% to the developer guild.
...
This is an abbreviated set of instructions on how to configure AEP fees. For a complete set of instructions refer to the [AEP fee router introduction](/launch-arbitrum-chain/02-configure-your-chain/common/aep-fees/01-aep-fee-router-introduction.mdx).

Additional resources:

- [Setup AEP fee router](/launch-arbitrum-chain/02-configure-your-chain/common/aep-fees/02-set-up-aep-fee-router.mdx)
- [Calculate AEP fees](/launch-arbitrum-chain/02-configure-your-chain/common/aep-fees/03-calculate-aep-fees.mdx)
- [Reporting on AEP fees](/launch-arbitrum-chain/02-configure-your-chain/common/aep-fees/04-reporting-on-fees.mdx)

...
The [BoLD adoption for Arbitrum chains](/launch-arbitrum-chain/02-configure-your-chain/common/validation-and-security/bold-adoption-for-arbitrum-chains.mdx) page has a lot more detailed specifics about the inner workings of BoLD if you are unsure about whether to adopt it for your chain.
...
For specfics on configuration refer to the [How to adopt Arbitrum BoLD](/launch-arbitrum-chain/02-configure-your-chain/common/validation-and-security/bold-adoption-for-arbitrum-chains.mdx#how-to-adopt-arbitrum-bold) section on that page.

# How to run a normal sequencer node for an Arbitrum chain
...
We also provide a [guide for running a high-availability sequencer node for an Arbitrum chain](/launch-arbitrum-chain/07-arbitrum-node-runners/05-high-availability-sequencer-docs.mdx).
:::
...
Latest Docker image: <code>@@latestNitroNodeImage=offchainlabs/nitro-node:v3.9.4-7f582c3@@</code>
